  ...
  <div class="auth-card">
    ...
    <form action="${pageContext.request.contextPath}/register" method="post">
      <div class="form-group">
        ...
        %>
        <input type="text" name="username" placeholder="Tối thiểu 3 ký tự" required autofocus
               value="<%= savedUsername %>">
      </div>
      <div class="form-group">
        <label>Email <span style="color:var(--text-muted);font-weight:400;">(tuỳ chọn)</span></label>
        <%
